...
public class ChessGame {
    ...
    public static void main(String[] args) throws IOException{
        //pieces
        // use the chess.png and cuts each individual piece
        ...
        //board limits and size
        frame.setBounds(10,10,520,528);
        frame.setUndecorated(true);
        JPanel pn = new JPanel(){
            //protected void paintBorder(java.awt.Graphics g) {};
            @Override
            public void paint(java.awt.Graphics g) {
                //gameboard and colors
                boolean white = true;
        ...
        frame.addMouseListener(new MouseInputListener() {
            ...
            public void mousePressed(MouseEvent e) {
                // TODO Auto-generated method stub
                System.out.println((Piece(e.getX(), e.getY()).isWhite?" white ":" black ") + Piece(e.getX(), e.getY()).name);
                selectedPiece = Piece(e.getX(), e.getY()); 
    ...
    public static Piece Piece (int x, int y){
        int xp = (x / 64); 
        int yp = (y / 64);
